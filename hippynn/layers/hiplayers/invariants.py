...
default_invariants_list = [
    ...
    "ijkl,ijkm,labc,mabc->,four,four,four,four",
    "ijk,ilm,jkab,lmab->,three,three,four,four",
    "ijk,abc,ijkl,abcl->,three,three,four,four",
    "i,j,k,l,ijkl->,one,one,one,one,four",
    "ijk,ijl,klm,mabc,abc->,three,three,three,four,three",
    "ijk,ijl,lma,mabc,bck->,three,three,three,four,three",
    "ijk,ijl,abcm,abcd,klmd->,three,three,four,four,four",
    "ijkl,ijkm,abcd,abce,lmde->,four,four,four,four,four",
]
